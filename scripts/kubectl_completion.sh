# echo "Kubectl autocompletion loaded"

# Skip if PROMPTLY_DISABLE_KUBECTL_COMPLETION is set
if [[ -n "$PROMPTLY_DISABLE_KUBECTL_COMPLETION" ]]; then
  return
fi

# Generated from `kubectl completion zsh`
#compdef kubectl
