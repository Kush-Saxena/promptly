# extracted from https://raw.githubusercontent.com/ohmyzsh/ohmyzsh/refs/heads/master/plugins/kubectl/kubectl.plugin.zsh
# echo "Loading common aliases script"

# Skip if PROMPTLY_DISABLE_COMMON_ALIASES is set
if [[ -n "$PROMPTLY_DISABLE_COMMON_ALIASES" ]]; then
  return
fi
...
_build_kubectl_out_alias "kyq"  'kubectl "$@" -o yaml | yq'
